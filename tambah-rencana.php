                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_dompet" name="rencana" class="form-control" placeholder="Masukkan Rencana Tabungan Anda..." required>
                                </div>

                                <div class="form-group">
                                    <label for="target">Target<i class="fas fa-star-of-life" style="font-size: 7px; vertical-align: top; color: #ED2939"></i></label>
                                    <input type="text" id="saldo" name="target" class="form-control" placeholder="Masukkan target yang ingin dicapai..." onkeyup="formatRupiah(this)" required>
                                </div>
                            ...
                            <?php
                                if (isset($_POST['btn-simpan'])) {
                                    ...
                                    $query_insert = mysqli_query($mysqli, "INSERT INTO `rencana`( `rencana`, `target`,tertabung,`id_pengguna`) VALUES ('$rencana','$saldo','0','$id_pengguna')");
